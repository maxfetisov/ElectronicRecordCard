...
import diploma.electronicrecordcard.service.version.impl.ControlTypeVersionService;
...
public class ControlTypeController {
    ...
    ControlTypeVersionService controlTypeVersionService;
    ...
    public ResponseEntity<List<ControlTypeDto>> getByVersion(@PathVariable("version") Long version) {
        return ResponseEntity.ok(controlTypeVersionService.getByVersion(version));
    }
