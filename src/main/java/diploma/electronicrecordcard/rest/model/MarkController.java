...
import diploma.electronicrecordcard.service.version.impl.MarkVersionService;
...
public class MarkController {
    ...
    MarkVersionService markVersionService;
    ...
    public ResponseEntity<List<MarkDto>> getByVersion(@PathVariable("version") Long version) {
        return ResponseEntity.ok(markVersionService.getByVersion(version));
    }
