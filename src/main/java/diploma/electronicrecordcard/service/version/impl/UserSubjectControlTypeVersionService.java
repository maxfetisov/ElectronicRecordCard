...
public class UserSubjectControlTypeVersionService
    ...
    public UserSubjectControlTypeVersionService(VersionRepository<UserSubjectControlType> repository, Mapper<UserSubjectControlTypeDto, UserSubjectControlType> mapper) {
